...
class staff{
    ...
    void new_Staff(){
        ...
        System.out.println("please enter staff desigination :-");
        dEsg=input.nextLine();
        System.out.println("please enter staff sex :-");
        sex=input.nextLine();
        System.out.println("please enter staff salary");
        salary=input.nextInt();
    }
    void staffInfo(){
        System.out.println("staff information is the next :-");
        System.out.println("sId :- "+sId+" sname :- "+sName+" desg :-"+dEsg+" sex :- "+sex +" salary :- "+salary);
    }
}
class doctor{
    ...
    void new_doctor(){
        ...
        System.out.println("please enter doctor specilist :-");
        specilist=input.nextLine();
        System.out.println("please enter doctor qualification ");
        doc_qual=input.nextLine();
        System.out.println("please enter the number of room ");
        dRoom=input.nextInt();
    }
    void doctor_Info(){
        System.out.println("please enter the doctor information ");
        System.out.println("Did :-"+dId+" Dname "+dName +" Specilist :- "+specilist+"Qualification :-"+doc_qual+" DRoom"+dRoom);
    }
}
class patient{
    String pId,pName,disease,sex,admit_statuse;
    int age;
    void new_patient(){
        Scanner input = new Scanner(System.in);
        ...
        System.out.println("pleae enter patient disease :-");
        disease =input.nextLine();
        System.out.println("please enter patient sex :-");
        sex=input.nextLine();
        System.out.println("please enter patient admit_statuse :-");
        admit_statuse=input.nextLine();
        System.out.println("lease enter patient age :-");
        age=input.nextInt();
    }
    void patient_info(){
        System.out.println("The information of the patient is the next :-");
        System.out.println("Pid :-"+pId+" Pname :-"+pName+" Disease :-"+disease+" Sex :-"+sex+" Admit_statuse"+admit_statuse+"Age :-"+age);
...
class medical
{
    ...
    void find_medi()
    { 
        System.out.println("The information of the medical :-");
